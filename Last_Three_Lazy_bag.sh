...
if [ "$user_password" = "$correct_password" ]; then
    ...
    echo "2.   创建根目录文件夹" 
    echo "3.   安装全部服务"
    echo "4.   仅安装视频服务 nastool 、 jellyfin 、 qbittorrent 、 transmission 、 iyuuplus 、 xunlei 、jackett 、 alist-tvbox 、 aipan "
    echo "5.   仅安装音乐服务 navidrome music-tag-web "
    echo "6.   仅安装小说服务 reader "
    echo "7.   仅安装漫画服务 komga "
    echo "8.   仅安装办公服务 WPS 、 微力同步 、 PDF工具箱 、 在线预览文件 、 思源笔记 、 Alist "
    echo "9.   仅安装网络服务 v2raya 、 frpc"
    echo "10.  仅安装美化服务 sun-panel "
    echo "11.  仅安装娱乐服务 GBA模拟器 "
    echo "12.  仅安装系统服务 青龙面板 Home Assistant "
